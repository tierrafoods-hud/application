...
def sidebar(title="Tierrasphere Carbon Capture Prediction Application", about="", layout_style="centered"):
    ...
    with st.sidebar:
        ...
        st.markdown("""
                <div>
                    <h3 style="font-size: 14px; font-weight: bold; color: #306f56;">Advanced Model Training</h3>
                    <p style="font-size: 12px; color: #306f56;">
                        These tools are for training and managing machine learning models. Please ensure you understand the model training process before proceeding.
                    </p>
                </div>
        ...
        st.markdown("""
                <div style="text-align: center;">
                    <h3 style="font-size: 14px; font-weight: bold; color: #306f56;">Developed in collaboration with
                        <a href="https://www.tierrasphere.com/" target="_blank" rel="noopener noreferrer">Tierrasphere</a> and 
